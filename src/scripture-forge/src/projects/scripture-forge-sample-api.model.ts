...
/** Mock implementation of the SF API for testing */
export default class ScriptureForgeSampleApi extends ScriptureForgeApi {
  ...
  override async getLastCompletedDraftStatus(
    ...
    const draftStatusCompleted: SlingshotDraftBuildInfo = {
      queueDepth: 0,
      additionalInfo: {
